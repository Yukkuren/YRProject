...
public:
	...
	void Init(YR_Vector3 pl_pos, YR_Vector3 distance, YR_Vector3 range);		//全てゼロクリア(プレイヤーの初期位置に当たり判定をつけるためプレイヤーの座標をもらっている)
	void Draw(
		YRShader *shader,
	...
	void Update(YR_Vector3 pl_pos,float elapsed_time);	//毎回座標とサイズを受け取って更新
