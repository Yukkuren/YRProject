...
//#endif // 0
	...
	{
		std::string file_level_R = std::string("./Data/FBX/Knight/AnimationR/knight_");
		std::string file_level_L = std::string("./Data/FBX/Knight/AnimationL/knight_");
	...
	{
		model_motion.air_jump_R = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_air_jump_R.fbx");
	}
	if (model_motion.air_jump_L == nullptr)
	{
		model_motion.air_jump_L = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_air_jump_L.fbx");
	}

	//ジャンプ落下移行
	if (model_motion.jumpToFall_R == nullptr)
	{
		model_motion.jumpToFall_R = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_jumpToFall_R.fbx", true);
	}
	if (model_motion.jumpToFall_L == nullptr)
	{
		model_motion.jumpToFall_L = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_jumpToFall_L.fbx", true);
	}

	//ジャンプ落下中
	if (model_motion.fall_R == nullptr)
	{
		model_motion.fall_R = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_fall_R.fbx");
	}
	if (model_motion.fall_L == nullptr)
	{
		model_motion.fall_L = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_fall_L.fbx");
	}

	//着地
	if (model_motion.landing_R == nullptr)
	{
		model_motion.landing_R = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_landing_R.fbx");
	}
	if (model_motion.landing_L == nullptr)
	{
		model_motion.landing_L = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_landing_L.fbx");
	}
	...
	//	else*/
	//	{
	//		model_motion.model_R_Act[scastI(ActState::WAIT)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_wait_R.fbx");
	//	}
	//}
	//if (model_motion.model_L_Act[scastI(ActState::WAIT)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::WAIT)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_wait_L.fbx");
	//}

	////ガードモーション
	//if (model_motion.model_R_Act[scastI(ActState::GUARD)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::GUARD)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_guard_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::GUARD)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::GUARD)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_guard_L.fbx");
	//}

	////スライドモーション
	//if (model_motion.model_R_Act[scastI(ActState::SLAM)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::SLAM)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_slid_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::SLAM)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::SLAM)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_slid_L.fbx");
	//}

	////しゃがみ
	//if (model_motion.model_R_Act[scastI(ActState::SQUAT)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::SQUAT)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_squat_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::SQUAT)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::SQUAT)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_squat_L.fbx");
	//}
	...
	//{
	//	model_motion.model_R_Act[scastI(ActState::RETREAT)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_back_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::RETREAT)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::RETREAT)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_back_L.fbx");
	//}

	////ダッシュ
	//if (model_motion.model_R_Act[scastI(ActState::DASH)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::DASH)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_dash_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::DASH)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::DASH)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_dash_L.fbx");
	//}

	////バックステップ
	//if (model_motion.model_R_Act[scastI(ActState::BACK)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::BACK)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_backstep_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::BACK)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::BACK)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_backstep_L.fbx");
	//}

	////空中ダッシュ
	//if (model_motion.model_R_Act[scastI(ActState::AIR_F)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::AIR_F)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_air_dash_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::AIR_F)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::AIR_F)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_air_dash_L.fbx");
	//}

	////空中バックステップ
	//if (model_motion.model_R_Act[scastI(ActState::AIR_B)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::AIR_B)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_air_back_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::AIR_B)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::AIR_B)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_air_back_L.fbx");
	//}

	////受け身
	//if (model_motion.model_R_Act[scastI(ActState::PASSIVE)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::PASSIVE)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_passive_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::PASSIVE)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::PASSIVE)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_passive_L.fbx");
	//}

	////ジャンプ
	//if (model_motion.model_R_Act[scastI(ActState::JUMP)] == nullptr)
	//{
	//	model_motion.model_R_Act[scastI(ActState::JUMP)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationR/knight_jump_R.fbx");
	//}
	//if (model_motion.model_L_Act[scastI(ActState::JUMP)] == nullptr)
	//{
	//	model_motion.model_L_Act[scastI(ActState::JUMP)] = std::make_shared<Model>("./Data/FBX/Knight/AnimationL/knight_jump_L.fbx");
	//}
